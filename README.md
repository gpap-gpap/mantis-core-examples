...
Demo notebooks for the mantis codebase - for a web app that allows you to run mantis models in your browser [get in touch](https://www.mantis-geophysics.com/)
